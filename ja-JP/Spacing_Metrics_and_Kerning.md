...
<ul>
  <li>「**送り幅のみ**」（"_**Advance&nbsp;Width&nbsp;Only**_"）：　このモードでは、メトリック・ビューはグリフの「送り幅」調整のみに使用できます。</li>
  <li>「**両方**」（"_**Both**_"）：　このモードでは、メトリック・ビューは「送り幅」か「カーニング」のどちらかを調整できます。</li>
</ul>
...
<p class="note">**【注意】**　上記の内容は、言及されている文字で正しいサイドベアリング値を見つけるための出発点として、超効果的なガイドライン（目安）です。</p>
...
<ul>
  <li>「<b>カーニングのみ</b>」（"_**Kerning&nbsp;Only**_"）：　このモードでは、メトリック・ビューは「カーニング」調整のみに使用できます。</li>
  <li>「<b>両方</b>」（"_**Both**_"）：　このモードでは、メトリック・ビューは「送り幅」か「カーニング」のどちらかを調整できます。</li>
</ul>
