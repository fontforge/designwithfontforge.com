...
Find a glyph with three dots — *sheen* (position 1588, U+0634) will do. Double-click on the cell — this will open a glyph design panel. Press <kbd>V</kbd> to ensure the pointer tool (arrowhead) in the toolbox is selected, and press <kbd>Z</kbd> and enlarge the panel to give you a good view of the glyph.
