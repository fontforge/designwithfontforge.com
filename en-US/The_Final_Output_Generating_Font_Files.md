...
You should also simplify your glyphs where possible — not eliminating details, but eliminating redundant points. This reduces file sizes slightly for every glyph, which adds up considerably over the entire set of characters in the font.
