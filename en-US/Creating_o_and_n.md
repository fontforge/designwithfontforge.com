...
[baseline](Glossary.md#Baseline), the curve must actually sit a little below the line, producing an [*undershoot*](Glossary.md#Undershoot). The
portion of the character that dips just below the baseline in order to appear sitting on the
baseline is called the [*underhang*](Glossary.md#Underhang) &mdash; demonstrated below. Without underhang, characters with
...
at the [X-height](Glossary.md#X-height) and at the [Cap-height](Glossary.md#Cap-height) (see below).
...
the very basic bowl weight and shape, the white &mdash; or [counter](Glossary.md#Counter) &mdash; provides the size and
...
the [side bearings](Glossary.md#Side_Bearing) of your ‘o’ as well.  As a general principle, with the exception of slanted or
...
lowercase ‘n,’ which you will insert into your string of ‘o’s.

If we look at the anatomy of an ‘n’, we can break it apart into two or three components consisting of a [*stem*](Glossary.md#Stem) and a <i>curve</i>.
...
can be re-used later when forming other characters; e.g., the stem at the left of the ‘n’ can be
...
Taking yourself forward again to the chapter on [“Spacing, Metrics, and Kerning”], the design of the ‘n’ character
