...
La création d'une version en caractères gras d'une police peut être approximée rapidement en exécutant le filtre appelé <em>Changer la graisse</em> (que vous trouverez dans "_**Elément**&nbsp;⇨&nbsp;**Style**&nbsp;⇨&nbsp;**Changer&nbsp;la&nbsp;graisse**_") pour ajouter de la graisse à vos glyphes.
